<?php
//отправка на почту смс
    session_start ();
    if(isset($_POST["send"])){
        $to = "vasia.motnin@gmail.com"; // почта
...
// обратный отсчет
    ...
    $datetime2 = new DateTime('20181029');//Дата события, где 2017-это год, 09-это месяц и 10 - день события     
     
    $datetime3 = new DateTime(date("H:i:s"));//Получаем текущее время
    $datetime4 = new DateTime('20:00:00');//Время события где первые 00 - Это часы, вторые - это минуты и последние - это сек     
